...
export const projectData: ProjectData[] = [
  ...
  },
  {
    id: '2',
    title: '픽답 (진행 중)',
    thumbnail: '/projects/pickdap.png',
    summary: 'AI로 완성하는 면접 준비, 픽답',
    period: '2025. 12. ~ Now',
    role: 'Publisher',
    stack: ['Next', 'TypeScript', 'Tailwind CSS', 'Zustand'],
    highlights: ['Tailwind CSS로 빠르게 UI 구현'],
    links: [
      { label: 'GitHub', href: 'https://github.com/MyNameSieun/pick-dap' },
    ],
  },
  {
    id: '3',
